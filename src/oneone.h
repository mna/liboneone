...
#define oneone_VERSION_MAJOR 0
#define oneone_VERSION_MINOR 0
#define oneone_VERSION_PATCH 0
...
one_locked_val_s* one_locked_val_new(void* const initial_val);

void* one_locked_val_free(one_locked_val_s* const lv);

void* one_locked_val_set(one_locked_val_s* const lv, void* const new_val);

void* one_locked_val_get(one_locked_val_s* const lv);

void* one_locked_val_with(one_locked_val_s* const lv,
                          one_locked_val_fn fn,
                          void* const arg);
...
one_rwlocked_val_s* one_rwlocked_val_new(void* const initial_val);

void* one_rwlocked_val_free(one_rwlocked_val_s* const rwlv);

void* one_rwlocked_val_set(one_rwlocked_val_s* const rwlv, void* const new_val);

void* one_rwlocked_val_get(one_rwlocked_val_s* const rwlv);

void* one_rwlocked_val_read_with(one_rwlocked_val_s* const rwlv,
                                 one_locked_val_read_fn fn,
                                 void* const arg);

void* one_rwlocked_val_with(one_rwlocked_val_s* const rwlv,
                            one_locked_val_fn fn,
                            void* const arg);
...
one_version_s one_version(void);
